...
public class MainViewModel : BaseViewModel
{
    ...
    private async Task SetAbonents() => Abonents = await _repository.GetAbonents(CurrentPage, CountPerPage);
    ...
    public RelayCommand NavToStreetsPage => new(_ => new Streets(_repository).ShowDialog());
